...
OWNER=ninjablocks
BIN_NAME=driver-go-sonos
PROJECT_NAME=driver-go-sonos
...
if [ ! -d $GOPATH/src/github.com/ninjasphere/go-ninja ]; then
	...
	git clone -b 'add_media_player' git@github.com:ninjasphere/go-ninja.git $GOPATH/src/github.com/ninjasphere/go-ninja
fi
